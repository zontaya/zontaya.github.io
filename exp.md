...
#### 1. สร้าง project บน fcm 
ไปที่ firebase หน้า setting แท็บ cloud massaging 
 - token ใช้ในข้อการ push 
 - sender id ให้ใส่ไว้ใน manifast.json

<img src="http://10.100.1.7:9080/sontaya/pwa/raw/master/images/sw5.png" width="500">